 ...
 *
 */
class MCP3008(private val csPin: String, private val clockPin: String, private val mosiPin: String, private val misoPin: String) {

    private var mCsPin: Gpio? = null
    private var mClockPin: Gpio? = null
    private var mMosiPin: Gpio? = null
    private var mMisoPin: Gpio? = null

    private// first bit is 'null', so drop it
    ...
    private fun initChannelSelect(channel: Int) {
        ...
        for (i in 0..4) {
            ...
            if (commandout and 0x80 != 0x0) {
                mMosiPin!!.value = true
            } else {
                mMosiPin!!.value = false
            }
